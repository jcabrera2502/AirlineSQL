...
-- Ticket and Passenger Relation --
SELECT * 
FROM TICKET, PASSENGER
WHERE TICKET.Passenger_id = PASSENGER.Passenger_id;

-- Passenger and Baggage Relation --
SELECT * 
FROM BAGGAGE, PASSENGER
WHERE BAGGAGE.Passenger_id = PASSENGER.Passenger_id;

-- Ticket and Flight Relation
SELECT * 
FROM TICKET, FLIGHTS
...
-- Additional Insertions to help with Queries --
...
INSERT INTO PASSENGER (Passenger_id, Passenger_name, Birthdate)
VALUES ('P18317783817182', 'John Smith', TO_DATE('1978-6-28','yyyy-mm-dd'));
...
INSERT INTO TICKET(Ticket_number, Seat_number, Fare_cost, Passenger_id, Flight_id) --inserting alex, flight ID goes back to flight_number.
VALUES ('89979792779178', '21B', '437.20', 'P18317783817182','JK5190');

INSERT INTO TICKET(Ticket_number, Seat_number, Fare_cost, Passenger_id, Flight_id) --inserting alex, flight ID goes back to flight_number.
VALUES ('90875983671986', '23C', '237.23', 'P18317783817182','NK9384');
...
INSERT INTO BAGGAGE(Bag_id, Weight, Color, Passenger_id)
VALUES ('WHYUZ64923', '25.20', 'Gray', 'L10987654321023'); --carlos

INSERT INTO BAGGAGE(Bag_id, Weight, Color, Passenger_id)
VALUES ('MPVWJ84601', '30.35', 'Blue', 'L10987654321023');-- carlos
INSERT INTO BAGGAGE(Bag_id, Weight, Color, Passenger_id)
VALUES ('FWPQZ53019', '27.81', 'Purple', 'L10987654321023'); --carlos

INSERT INTO BAGGAGE(Bag_id, Weight, Color, Passenger_id)
VALUES ('PLQMZ80352', '52.13', 'Yellow', 'L10987654321023');-- carlos
